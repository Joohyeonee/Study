...
# 파일에서 X로 시작해서 Y로 끝나는 특정문자열 지우기
# 1. 시작점에서 특정문자의 X의 인덱스 찾기
# 2. X에서 찾은 열부터 특정문자열의 X의 인택스 찾기
# > 정확히는 C로 시작해서 x으로 끝나는 문자열
...
if __name__ == '__main__':
    ...
    parser.add_argument('--src', default="C:\\workdir\\video.mp4")
